...
// let title = document.getElementById('title');   // ! получить элементы по идентификатору
// let list = document.getElementsByTagName('ul');   // ! получить элементы по имени тега
// let items = document.getElementsByClassName('item');  // ! получить элементы по имени класса
// let inp = document.getElementsByName('inp-name')  // ! получить элементы по имени
// console.log(inp);
...
// let title = document.querySelector('#title')   // ! селектор запросов
// let list = document.querySelectorAll('ul')  // ! Селектор запросов Все
...
// ? попробуем динамически добавить эллай тег в тег юэл, у нас сейчас есть 3 элемента маркировонного списка и мы хотим динамически добавить еще 4 эдемент
...
// newElem.innerHTML = '<span>I am a new element</span>';  // ? создали элементa
...
// container[0].append(elem1);  // ? push - он принимает как дом элементы, так и cтроки.Позволяет вставить несколько значений, нечего не возвращяет
...
//  ? getHours() возвращяет нам только часы
...
// title.innerHTML = '<span>Kani</span>' // ? видет теги  // Kani
// title.innerText = '<span>Kani</span>' // ? не видит теги  // <span>Kani</span>
